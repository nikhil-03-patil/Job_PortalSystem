...
public List<Jobs> getJobsAndLocationAndCate(String category, String location){
	...
	System.out.println("Inside update job:::::::"+ j.getTitle());
	
	System.out.println("Inside update job:::::::"+ j.getDescription());

	System.out.println("Inside update job:::::::"+ j.getCategory());
	
	System.out.println("Inside update job:::::::"+ j.getStatus());
	
	System.out.println("Inside update job:::::::"+ j.getLocation());

	System.out.println("Inside update job:::::::"+ j.getId());
	
	String sql="update job_portal_2.jobs set title=?, description=?, category=?, status=?, location=? where id=? ";
